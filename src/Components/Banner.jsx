      ...
      <div className="hero-content flex-col lg:flex-row-reverse md:mx-40">
        ...
        >
          <div className="w-[90%] pt-5">
            ...
            {/* Typed animation here */}
            <h3 className="text-3xl font-bold my-10 text-amber-600">
              <span ref={typedElement}></span>
            </h3>

            <p className="py-6">
              I'm a passionate web developer from Bangladesh. I love turning ideas into digital
              solutions using the MERN stack. I’m dedicated to continuous <br /> learning and
              building useful, user-friendly applications.
            </p>
            ...
            <div className="flex gap-2 mt-3 justify-center lg:justify-start text-3xl text-gray-600">
              ...
              >
                <FaGithub className="text-gray-700 hover:text-black dark:text-white transition" />
              </a>
              <a
